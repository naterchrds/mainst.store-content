...
?>
<?php do_action( 'cactus_before_demo_content_install' ); ?>
...
<div class="theme-browser rendered" id="fw-ext-backups-demo-list">
	<div class="demo-admin-title">
		<h2><span class="dashicons dashicons-archive"></span><span class="text"><?php esc_html_e('Choose a sample data package','cactus-unyson-backup-extension');?></span></h2>
	</div>
	...
	<div id="cactus-dialog-confirm" title="">
	  <p id="cactus-dialog-content"></p>
	</div>
</div>
<?php do_action( 'cactus_after_demo_content_install' ); ?>