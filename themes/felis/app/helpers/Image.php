<?php
    ...
    class Image
    {
        public function __contstruct()
        {
            ...
            add_filter( 'cactus_image_placeholder_url', array($this, 'imagePlaceholderUrlFilter'), 10, 2 );
        }

        public function imagePlaceholderUrlFilter($url, $image_size)
        {
            switch ($image_size) {
                case 'cactus_misc_thumb_11':
                case 'cactus_misc_thumb_10':
                case 'cactus_misc_thumb_9':
                case 'cactus_misc_thumb_8':
                case 'cactus_misc_thumb_7':
                case 'cactus_misc_thumb_6':
                case 'cactus_misc_thumb_5':
                case 'cactus_misc_thumb_4':
                    break;
                default:
