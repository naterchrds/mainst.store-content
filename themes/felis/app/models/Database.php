<?php
	...
	class Database extends Data {
		 ...
		 * 'meta_query_value' - array - array meta value
		 * 'key' - string - meta key
		...
		public static function getRelatedPosts( $post_id = null ) {
			...
			$number              = Cactus::getOption( 'related_posts_count', 3 );
			$relatedPostsOrderBy = Cactus::getOption( 'related_posts_order_by', 'date' ); // date or rand
			...
			$get_related_post_by = Cactus::getOption( 'get_related_post_by' );
