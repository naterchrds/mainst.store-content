<?php
    ...
    class Ads extends Models\Metadata
    {
        ...
        {
            $this->adsense_id = \App\Cactus::getOption('adsense_id');
        }
        ...
        private function get_ad_slots(){
            $ad_slots = array(
                    'slot_1' => 'Ad Slot Position 1',
                    'slot_2' => 'Ad Slot Position 2',
                    'slot_3' => 'Ad Slot Position 3'
                );
                
            return apply_filters('cactus_ad_slots', $ad_slots);
        }
         ...
         */
        private function get_gooogle_responsive_ad( $pub_id, $slot_id ){
            $idx = rand(0,1000);
        ...
        public function get_ad( $ad_pos, $class = '' ){
            $slot_id = \App\Cactus::getOption('adsense_slot_' . $ad_pos);
            $pub_id = $this->adsense_id;
            
            $html = '';
            
            if($pub_id != '' && $slot_id != ''){
                $html .= '<div class="ad ' . esc_attr($class) . '">' . $this->get_gooogle_responsive_ad($pub_id, $slot_id) . '</div>';
            } else {
                $html .= '<div class="ad ' . esc_attr($class) . '">' . \App\Cactus::getOption( $ad_pos ) . '</div>';
            }
