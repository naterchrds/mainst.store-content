<?php
    ...
    class ParseThumbnail
    {
        ...
        public function render($size = array(), $post_id = -1, $source_sizes = '')
        {
            ...
            $size = apply_filters('felis_thumbnail_size_filter', $size, $post_id);
            ...
            if (function_exists('wp_get_attachment_image_srcset')) {
                ...
                $lazyload  = Cactus::getOption('lazyload', 'off');
                $lazyClass = '';
                ...
                $image_attributes = wp_get_attachment_image_src($attachment_id, $size);
                   ...
                   if ($lazyload == 'on') {
                    ...
                    //     $ratio = 'style="padding-top:'.($image_attributes[2]/$image_attributes[1]*100).'%; height:0px "';
                    // }

                    if ( $image_attributes[2]/$image_attributes[1] <= 1 ) {
                        $ratio_img = ($image_attributes[2]/$image_attributes[1]*100);
                        $ratio = 'style="padding-top:'.$ratio_img.'%; height:0px "';
                    } else {
                        $ratio_img = $image_attributes[2];
                        $ratio = 'style="padding-top:'.$ratio_img.'px; height:0px "';
                    }
                   ...
                   //  }
                    ...
                    $lazyload_dfimg = apply_filters('cactus_image_placeholder_url', get_parent_theme_file_uri('/images/dflazy.jpg'), $size);

                    $lazyClass = ' class="lazyload effect-fade img-responsive center-block" src="' . $lazyload_dfimg . '" ' . $ratio;
                } else {
                    $lazyClass = ' class="img-responsive center-block" ';
                }
