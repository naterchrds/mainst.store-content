...
class ClassCollectionLoader
{
    ...
    public static function load($classes, $cacheDir, $name, $autoReload, $adaptive = false, $extension = '.php')
    {
        ...
        if (!is_dir($cacheDir) && !@wp_mkdir_p($cacheDir, 0777, true) && !is_dir($cacheDir)) {
        ...
        if ($autoReload) {
            ...
            if (!is_file($metadata) || !is_file($cache)) {
                ...
                $meta = unserialize($wp_filesystem->get_contents($metadata));
    ...
    public static function inline($classes, $cache, array $excluded)
    {
        ...
        foreach (self::getOrderedClasses($classes) as $class) {
            ...
            $c = $wp_filesystem->get_contents($file);
    ...
    private static function writeCacheFile($file, $content)
    {
        ...
        if (false !== @$wp_filesystem->put_contents($tmpFile, $content) && @rename($tmpFile, $file)) {
