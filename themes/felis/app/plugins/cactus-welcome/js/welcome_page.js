jQuery(document).ready(function(){
    ...
    jQuery('#ct_support_forum').parent().attr('target','_blank');
    jQuery('#ct_documentaion').parent().attr('target','_blank');
    jQuery('#option-tree-sub-header').append('<span class="option-tree-ui-button left logo"> ' + jQuery('#ot_logo_image').html() + '</span>');
    jQuery('#option-tree-sub-header').append('<span class="option-tree-ui-button left vesion "> ' + jQuery('#current_version').text() + '</span>');
