<?php
    ...
    namespace App\Plugins\Cactus_Option_Tree;
    ...
    class OptionTree
    {
        ...
        public function insertRow()
        {
            ...
            $html .= '<h3 class="label">' . esc_html__('LESS Compiler', 'felis') . '</h3>';
            $html .= '</div>';

            $html .= '<div class="format-setting type-radio has-desc">';

            $html .= '<div class="description">' . esc_html__('Compile LESS into .css files, used for production', 'felis') . '</div>';
